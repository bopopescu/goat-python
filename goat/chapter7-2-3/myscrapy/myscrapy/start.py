...
# cmdline.execute("scrapy crawl app03".split())
# cmdline.execute("scrapy crawl app04".split())
# cmdline.execute("scrapy crawl app08".split())
cmdline.execute("scrapy crawl tyc".split())
